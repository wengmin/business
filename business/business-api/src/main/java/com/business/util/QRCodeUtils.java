...
public class QRCodeUtils {
    ...
    public static String getminiqrQr(String accessToken, HttpServletRequest request, String userId) {
        ...
        String codeUrl = urlPath + "/webapps/business/statics/qrdir" + twoCodePath;
        urlPath = urlPath + "/webapps/business/statics/qrdir";
        ...
        try {
            ...
            paramJson.put("path", "pages/card/index/index?userId=" + userId);
...
//			os.close();
     ...
     *
     */
    public static String getStaffIdQrCode(String accessToken, Long staffId, Integer id, String page) {
        try {
            URL url = new URL("https://api.weixin.qq.com/wxa/getwxacodeunlimit?access_token=" + accessToken);
            HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
            httpURLConnection.setRequestMethod("POST");// 提交模式
     ...
     *
     */
    public static String getCardQrCode(String accessToken, String userId) {
        try {
            URL url = new URL("https://api.weixin.qq.com/wxa/getwxacodeunlimit?access_token=" + accessToken);
            HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
            httpURLConnection.setRequestMethod("POST");// 提交模式
            ...
            // 发送请求参数
            JSONObject paramJson = new JSONObject();
            paramJson.put("scene", "userId=" + userId);
            paramJson.put("page", "pages/card/index/index");
